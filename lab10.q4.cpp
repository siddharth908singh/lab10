...
class rectangle{
	...
	void form(Point x, Point y);
	
	void printrect(void);
	
	int gets1(Point x, Point y);
	
	int gets2(Point x, Point y);
	...
	int length(Point x,Point y);
	
	int breadth(Point x,Point y);
...
int rectangle::gets1(Point x, Point y){
	return length(x,y);
}

int rectangle::gets2(Point x, Point y){
	return breadth(x,y);
}

int rectangle::length(Point x, Point y){
	int l;
	l = x.Get_X()-y.Get_X();
	return l;
}

int rectangle::breadth(Point x, Point y){
	int b;
	b = x.Get_Y()-y.Get_Y();
	return b;
}
...
// Declaring a point using default class constructor (x = y = 0):
	Point p1;
  	cout<< "The value of x coordinate for p1 is " << p1.Get_X() << endl;
  	cout<< "The value of y coordinate for p1 is " << p1.Get_Y() << endl;

// Declaring a point with coordinates X = 2, Y = 3:
  	Point p2(2, 3);
  	cout<< "The value of x coordinate for p2 is " << p2.Get_X() << endl;
  	cout<< "The value of y coordinate for p2 is " << p2.Get_Y() << endl;
...
//Lab 7 exercise 4.1. Test member function print on points p1, p2:
	cout<<"The coordinate of 1st point is : ";
	p1.print();
	cout<<endl;
	cout<<"The coordinate of 2nd point is : ";
	p2.print();
	cout<<endl;
